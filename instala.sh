...
v1=$(curl -sSL "https://raw.githubusercontent.com/AliveDedSec/ADM-MANAGER-ALPHA-RUSSIAN/main/Install/versaoatt")
...
echo -e "\033[1;36mwget https://raw.githubusercontent.com/AliveDedSec/ADM-MANAGER-ALPHA-RUSSIAN/main/Install/apt-source.sh && chmod 777 ./* && ./apt-*"
echo -e "$barra"
echo -ne "\033[0m"
exit 1
}
...
wget -O $HOME/versao https://raw.githubusercontent.com/AliveDedSec/ADM-MANAGER-ALPHA-RUSSIAN/master/versao  &> /dev/null
echo -e "$barra"
...
wget -O trans https://raw.githubusercontent.com/AliveDedSec/ADM-MANAGER-ALPHA-RUSSIAN/main/Install/trans -o /dev/null 2>&1
...
echo -e "$barra"
echo -ne "${cor[4]}"
wget -O lista https://raw.githubusercontent.com/AliveDedSec/ADM-MANAGER-ALPHA-RUSSIAN/main/Install/lista -o /dev/null
valid_fun
